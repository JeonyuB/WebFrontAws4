...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		var parentPObj = document.getElementById('parentDiv');
		parentPObj.addEventListener('click', parentPFunc);
	
		var childBtnObj = document.getElementById('childLink');
	...
	function childBtnFunc(event) {
		...
		demoTag.textContent = this.href;00000000000000000
