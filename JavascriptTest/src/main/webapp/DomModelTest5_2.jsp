...
window.onload = function() {
	...
	newP.setAttribute('style', 'border: 1px solid black');
	...
	theObj.setAttribute('style', 'backgroundColor: #ddd');
	
	newSpan1.setAttribute('style', 'border: 1px solid black');
	newSpan2.setAttribute('style', 'border: 1px solid black');
